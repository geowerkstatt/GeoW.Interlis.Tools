...
public class InterlisReader
{
    ...
    public InterlisFile ReadFile(TextReader textReader)
        => ReadRule(textReader, (p, v) => v.VisitInterlis(p.interlis()));
    ...
    /// <returns>The compiled representation of the <paramref name="textReader"/> input.</returns>
    public TResult ReadRule<TResult>(TextReader textReader, Func<Interlis24Parser, Interlis24Visitor, TResult> parseRule)
    {
